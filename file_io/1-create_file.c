 ...
 * text content to it. If the file already exists, it is truncated. If text_content
 * is NULL, an empty file is created. The function returns 1 on success and -1 on failure.
 *
